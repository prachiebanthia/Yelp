...
class BusinessesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, FiltersViewControllerDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        //table view delegates and autolayout
        tableView.delegate = self
        tableView.dataSource = self
        tableView.rowHeight = UITableViewAutomaticDimension
        tableView.estimatedRowHeight = 120
        
        //initializing all settings values
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        filtersViewController.distance1Mile = distance1Mile
        filtersViewController.distance3Mile = distance3Mile
        filtersViewController.distance5Mile = distance5Mile
        filtersViewController.distance20Mile = distance20Mile
        filtersViewController.delegate = self
    }
 
    //method for filter view delegate to transfer information
